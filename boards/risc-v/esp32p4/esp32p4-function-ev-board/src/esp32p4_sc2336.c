...
/* 1080p init sequence: software reset, system/PLL, MIPI output
 * (2-lane RAW10), 1920x1080 output window, exposure/gain defaults.
 */
...
static const struct sc2336_reg_s g_sc2336_init_1080p[] =
{
  ...
  { 0x3209, 0x80 },   /* width low   (1920 & ff) */
  { 0x320a, 0x04 },   /* height high (1080 >> 8) */
  { 0x320b, 0x38 },   /* height low  (1080 & ff) */
  { 0x3e01, 0x04 },
  { 0x3e02, 0x60 },
  { 0x3e03, 0x08 },
  { 0x3e09, 0x40 },
