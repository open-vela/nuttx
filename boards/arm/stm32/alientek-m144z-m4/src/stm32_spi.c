 ...
 * adapter, off-board sensors) extend the SPIDEV_* branches below; do NOT
 * add a full driver shopping-list here -- this BSP only
 * tracks what is physically on the board.
 */
