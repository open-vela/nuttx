...
/* Rockchip RK3588 Memory Map: RAM and Device I/O */

#define CONFIG_RAMBANK1_ADDR      0x30000000
#define CONFIG_RAMBANK1_SIZE      MB(16)
...
#define CONFIG_LOAD_BASE          0x30000000
