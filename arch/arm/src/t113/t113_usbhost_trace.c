/****************************************************************************
 * arch/arm/src/t113/t113_usbhost_trace.c
 *
 * Shared USB host trace format tables for T113 OHCI and EHCI drivers.
 * Mirrors arch/arm/src/sama5/sam_usbhost.c (Apache 2.0, NuttX upstream).
 *
...
static const struct t113_usbhost_trace_s g_trace1[TRACE1_NSTRINGS] =
{
  ...
  TRENTRY(EHCI_TRACE1_QTDFOREACH_FAILED,
          TR_EHCI, TR_FMT1,
          "EHCI ERROR: t113_qtd_foreach failed: %d\n"),
  ...
  TRENTRY(EHCI_TRACE1_ADDBPL_FAILED,
          TR_EHCI, TR_FMT1,
          "EHCI ERROR: t113_qtd_addbpl failed: %d\n"),
  ...
  TRENTRY(EHCI_TRACE1_RESET_FAILED,
          TR_EHCI, TR_FMT1,
          "EHCI ERROR: t113_reset failed: %d\n"),
...
static const struct t113_usbhost_trace_s g_trace2[TRACE2_NSTRINGS] =
{
#ifdef CONFIG_T113_OHCI
