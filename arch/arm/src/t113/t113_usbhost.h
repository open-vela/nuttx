/****************************************************************************
 * arch/arm/src/t113/t113_usbhost.h
 *
...
#ifndef __ARCH_ARM_SRC_T113_T113_USBHOST_H
#define __ARCH_ARM_SRC_T113_T113_USBHOST_H
...
/* Shared bringup: PHY power-on + CCU clocks/resets + AHB burst.
 * Called once before t113_ehci_initialize()/t113_ohci_initialize().
...
/* Shared interrupt top-half called from t113_ehci.c when both EHCI and
 * OHCI are enabled and share the USB1 IRQ line.
 */
...
enum usbhost_trace1codes_e
{
  ...
  EHCI_TRACE1_QTDFOREACH_FAILED,    /* EHCI ERROR: t113_qtd_foreach failed */
  ...
  EHCI_TRACE1_ADDBPL_FAILED,        /* EHCI ERROR: t113_qtd_addbpl failed */
  ...
  EHCI_TRACE1_QHCREATE_FAILED,      /* EHCI ERROR: t113_qh_create failed */
  EHCI_TRACE1_QTDSETUP_FAILED,      /* EHCI ERROR: t113_qtd_setupphase failed */
  EHCI_TRACE1_QTDDATA_FAILED,       /* EHCI ERROR: t113_qtd_dataphase failed */
  EHCI_TRACE1_QTDSTATUS_FAILED,     /* EHCI ERROR: t113_qtd_statusphase failed */
  EHCI_TRACE1_TRANSFER_FAILED,      /* EHCI ERROR: Transfer failed */
  EHCI_TRACE1_QHFOREACH_FAILED,     /* EHCI ERROR: t113_qh_foreach failed: */
  ...
  EHCI_TRACE1_RESET_FAILED,         /* EHCI ERROR: t113_reset failed */
...
#endif /* __ARCH_ARM_SRC_T113_T113_USBHOST_H */
