/****************************************************************************
 * arch/arm/include/mcx-nxxx/n947_irq.h
 *
...
#ifndef __ARCH_ARM_INCLUDE_MCX_NXXX_N947_IRQ_H
#define __ARCH_ARM_INCLUDE_MCX_NXXX_N947_IRQ_H
...
#define NXXX_IRQ_SCT0                   (NXXX_IRQ_EXTINT + 33)                /**< SCTimer/PWM interrupt */
#define NXXX_IRQ_CTIMER2                (NXXX_IRQ_EXTINT + 34)                /**< Standard counter/timer 2 interrupt */
#define NXXX_IRQ_LP_FLEXCOMM0           (NXXX_IRQ_EXTINT + 35)                /**< LP_FLEXCOMM0 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM1           (NXXX_IRQ_EXTINT + 36)                /**< LP_FLEXCOMM1 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM2           (NXXX_IRQ_EXTINT + 37)                /**< LP_FLEXCOMM2 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM3           (NXXX_IRQ_EXTINT + 38)                /**< LP_FLEXCOMM3 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM4           (NXXX_IRQ_EXTINT + 39)                /**< LP_FLEXCOMM4 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM5           (NXXX_IRQ_EXTINT + 40)                /**< LP_FLEXCOMM5 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM6           (NXXX_IRQ_EXTINT + 41)                /**< LP_FLEXCOMM6 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM7           (NXXX_IRQ_EXTINT + 42)                /**< LP_FLEXCOMM7 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM8           (NXXX_IRQ_EXTINT + 43)                /**< LP_FLEXCOMM8 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_LP_FLEXCOMM9           (NXXX_IRQ_EXTINT + 44)                /**< LP_FLEXCOMM9 (LPSPI/LPI2C/LPUART) */
#define NXXX_IRQ_ADC0                   (NXXX_IRQ_EXTINT + 45)                /**< Analog-to-Digital Converter 0 */
#define NXXX_IRQ_ADC1                   (NXXX_IRQ_EXTINT + 46)                /**< Analog-to-Digital Converter 1 */
...
#define NXXX_IRQ_USB0_FS                (NXXX_IRQ_EXTINT + 50)                /**< Universal Serial Bus - Full Speed interrupt */
#define NXXX_IRQ_USB0_DCD               (NXXX_IRQ_EXTINT + 51)                /**< Universal Serial Bus - Device Charge Detect interrupt */
#define NXXX_IRQ_RTC                    (NXXX_IRQ_EXTINT + 52)                /**< RTC Subsystem interrupt */
#define NXXX_IRQ_SMARTDMA               (NXXX_IRQ_EXTINT + 53)                /**< SmartDMA_IRQ */
#define NXXX_IRQ_MAILBOX                (NXXX_IRQ_EXTINT + 54)                /**< Inter-CPU Mailbox interrupt */
...
#define NXXX_IRQ_FLEXSPI0               (NXXX_IRQ_EXTINT + 58)                /**< Flexible Serial Peripheral Interface interrupt */
...
#define NXXX_IRQ_USDHC0                 (NXXX_IRQ_EXTINT + 61)                /**< Ultra Secured Digital Host Controller interrupt */
...
#define NXXX_IRQ_PLU                    (NXXX_IRQ_EXTINT + 70)                /**< Programmable Logic Unit interrupt */
#define NXXX_IRQ_FREQME                 (NXXX_IRQ_EXTINT + 71)                /**< Frequency Measurement interrupt */
#define NXXX_IRQ_SEC_VIO                (NXXX_IRQ_EXTINT + 72)                /**< Secure violation interrupt */
...
#define NXXX_IRQ_PQ                     (NXXX_IRQ_EXTINT + 76)                /**< Power Quad interrupt */
...
#define NXXX_IRQ_EDMA_1_CH8             (NXXX_IRQ_EXTINT + 85)                /**< eDMA_1_CH8 error or transfer complete */
#define NXXX_IRQ_EDMA_1_CH9             (NXXX_IRQ_EXTINT + 86)                /**< eDMA_1_CH9 error or transfer complete */
#define NXXX_IRQ_EDMA_1_CH10            (NXXX_IRQ_EXTINT + 87)                /**< eDMA_1_CH10 error or transfer complete */
#define NXXX_IRQ_EDMA_1_CH11            (NXXX_IRQ_EXTINT + 88)                /**< eDMA_1_CH11 error or transfer complete */
#define NXXX_IRQ_EDMA_1_CH12            (NXXX_IRQ_EXTINT + 89)                /**< eDMA_1_CH12 error or transfer complete */
#define NXXX_IRQ_EDMA_1_CH13            (NXXX_IRQ_EXTINT + 90)                /**< eDMA_1_CH13 error or transfer complete */
#define NXXX_IRQ_EDMA_1_CH14            (NXXX_IRQ_EXTINT + 91)                /**< eDMA_1_CH14 error or transfer complete */
#define NXXX_IRQ_EDMA_1_CH15            (NXXX_IRQ_EXTINT + 92)                /**< eDMA_1_CH15 error or transfer complete */
...
#define NXXX_IRQ_NPU                    (NXXX_IRQ_EXTINT + 97)                /**< NPU interrupt */
#define NXXX_IRQ_GDET                   (NXXX_IRQ_EXTINT + 98)                /**< Digital Glitch Detect interrupt */
#define NXXX_IRQ_VBAT0                  (NXXX_IRQ_EXTINT + 99)                /**< VBAT interrupt */
#define NXXX_IRQ_EWM0                   (NXXX_IRQ_EXTINT + 100)               /**< External Watchdog Monitor interrupt */
#define NXXX_IRQ_TSI_END_OF_SCAN        (NXXX_IRQ_EXTINT + 101)               /**< TSI End of Scan interrupt */
#define NXXX_IRQ_TSI_OUT_OF_SCAN        (NXXX_IRQ_EXTINT + 102)               /**< TSI Out of Scan interrupt */
#define NXXX_IRQ_EMVSIM0                (NXXX_IRQ_EXTINT + 103)               /**< EMVSIM0 interrupt */
#define NXXX_IRQ_EMVSIM1                (NXXX_IRQ_EXTINT + 104)               /**< EMVSIM1 interrupt */
#define NXXX_IRQ_FLEXIO                 (NXXX_IRQ_EXTINT + 105)               /**< Flexible Input/Output interrupt */
#define NXXX_IRQ_DAC0                   (NXXX_IRQ_EXTINT + 106)               /**< Digital-to-Analog Converter 0 interrupt */
#define NXXX_IRQ_DAC1                   (NXXX_IRQ_EXTINT + 107)               /**< Digital-to-Analog Converter 1 interrupt */
#define NXXX_IRQ_DAC2                   (NXXX_IRQ_EXTINT + 108)               /**< 14-bit Digital-to-Analog Converter interrupt */
...
#define NXXX_IRQ_HSCMP2                 (NXXX_IRQ_EXTINT + 111)               /**< High-Speed comparator2 interrupt */
...
#define NXXX_IRQ_BSP32                  (NXXX_IRQ_EXTINT + 133)               /**< CoolFlux BSP32 interrupt */
...
#define NXXX_IRQ_ETHERNET               (NXXX_IRQ_EXTINT + 139)               /**< Ethernet QoS interrupt */
#define NXXX_IRQ_ETHERNET_PMT           (NXXX_IRQ_EXTINT + 140)               /**< Ethernet QoS power management interrupt */
#define NXXX_IRQ_ETHERNET_MACLP         (NXXX_IRQ_EXTINT + 141)               /**< Ethernet QoS MAC interrupt */
#define NXXX_IRQ_SINC_FILTER            (NXXX_IRQ_EXTINT + 142)               /**< SINC Filter interrupt */
...
#define NXXX_IRQ_ETB0                   (NXXX_IRQ_EXTINT + 149)               /**< ETB counter expires interrupt */
...
#define NXXX_IRQ_CTI0                   (NXXX_IRQ_EXTINT + 155)               /**< Cross Trigger Interface interrupt */
...
#endif /* __ARCH_ARM_INCLUDE_MCX_NXXX_N947_IRQ_H */
