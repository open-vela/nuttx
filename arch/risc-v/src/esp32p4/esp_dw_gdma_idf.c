...
/****************************************************************************
 * DesignWare DW-GDMA high-level channel manager for ESP32-P4.
 *
 * The P4 display and camera pipelines push framebuffer data through the
 * DesignWare GDMA embedded in the SoC. This file manages the DMA
 * channels, the transfer descriptor (linked list item) pool and the
 * IRQ plumbing on top of the register-level HAL in esp-hal-3rdparty.
 * Buffer allocation goes through the NuttX kernel heap and interrupts
 * are attached with the chip-level IRQ helpers.
 ****************************************************************************/
