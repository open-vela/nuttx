...
/****************************************************************************
 * ESP-IDF/FreeRTOS to NuttX compatibility layer.
 *
 * The vendor HAL headers and the peripheral drivers ported on top of
 * them are written against the ESP-IDF runtime (logging macros, error
 * checking helpers, heap_caps allocation, FreeRTOS delays and
 * spinlocks). This header maps those primitives onto their NuttX
 * equivalents so the display/DMA drivers build unmodified.
 ****************************************************************************/
