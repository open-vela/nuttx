...
/****************************************************************************
 * DesignWare DW-GDMA channel manager for ESP32-P4 - public interface.
 *
 * Channel and linked-list descriptor handles follow the naming of the
 * vendor HAL so that the register-level ll headers can be used without
